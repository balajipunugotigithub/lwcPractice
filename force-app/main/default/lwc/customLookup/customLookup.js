...
import findRecords from '@salesforce/apex/cutomLookup.findRecords';
export default class CustomLookup extends LightningElement {
    ...
    handleOnchange(event) {
        ...
        alert('alert search key '+searchKey);
        console.log('searchKey in customlookup--->'+searchKey);
        alert('alert search key2 '+searchKey);
        findRecords({
            searchKey: searchKey,
            ...
            .then(result => {
                ...
                //    // console.log('records---->'+this.records[i].Name);
                //     this.records[i].Name = rec[this.searchfield];
                //    // console.log('rec[this.searchfield]-->'+rec[this.searchfield]);
                //    // console.log('records---->'+this.records[i].Name);
                // }
